...
///
/// The native library is bundled via build hooks (`hook/build.dart`) as a
/// code asset — there is no platform-specific plugin code.
///
/// ## Features
///
/// - Generate Privacy Pass token requests
/// - Finalize tokens from issuer responses
/// - Background processing via Isolate.run (no external dependencies)
/// - Memory-safe FFI bindings generated by package:ffigen
